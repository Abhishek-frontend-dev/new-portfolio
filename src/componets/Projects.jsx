  ...
  const projects = [
    {
      ...
      videoSrc: 'src/assets/product-filter-appin-js.mp4',
      thumbnail: 'src/assets/product-filter-appin-js.png',
    ...
    },
    {
      ...
      videoSrc: 'src/assets/product-filter-appin-react.mp4',
      thumbnail: 'src/assets/product-filter-appin-react.jpg',
...

    {
      ...
      videoSrc: 'src/assets/htmlcssjs-restorent-site.mp4',
      thumbnail: 'src/assets/htmlcssjs-restorent-site.jpg',
       technologies: [<FaJsSquare className='text-yellow-400'/>, <FaCss3Alt  className='text-blue-400'/>, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/to-do-listapp-react.mp4',
      thumbnail: 'src/assets/to-do-listapp-react.jpg',
       technologies: [<FaReact className='text-blue-600' />, <FaCss3Alt  className='text-blue-400'/>, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/quiz-app-react.mp4',
